...
# */
#
#  This makefile is made for stm32f401 using HAL driver based autogenerated at mbed online compiler.
#  based platform is [NUCLEO stm32f401]. 
...
STARTUP_SRC = $(DRIVERSDIR)/startup_stm32f401xe.s
...
LINKER_SCRIPT = $(DRIVERSDIR)/STM32F401RETx_FLASH.ld
...
CC_SYMBOLS = -DTARGET_FF_ARDUINO -DTARGET_NUCLEO_F401RE -DTOOLCHAIN_GCC -DTARGET_FF_MORPHO -DTARGET_LIKE_CORTEX_M3 -DTARGET_CORTEX_M -DTARGET_LIKE_MBED -DTARGET_STM32F4 -D__MBED__=1 -DARM_MATH_CM3 -DMBED_BUILD_TIMESTAMP=1463831794.11 -DTARGET_STM -DTOOLCHAIN_GCC_ARM -D__CORTEX_M3 -DTARGET_M3 -DTARGET_STM32F401RE -D STM32F401xE -std=c99
